...
let frep = { contextInfo: { externalAdReply: {title: packname, body: packname, sourceUrl: canal, thumbnail: await(await fetch(icons)).buffer() }}}
...
if (!db.data.chats[m.chat].modohorny && m.isGroup) throw `${esmsMT['aPorno']()}`
try{ 
switch (command) {  
case "vxxxporno":    
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖👀◗ *_Contenido_*... ✯✨`, fkontak, m)
break
case "vxxxporno2":    
await conn.sendFile(m.chat, enlace1, null, `᥀·࣭࣪̇˖👀◗ *_Contenido_*... ✯✨`, fkontak, m)
break 
case "vxxxlesbiana":      
await conn.sendFile(m.chat, enlace2, null, `᥀·࣭࣪̇˖👀◗ *_Contenido_*... ✯✨`, fkontak, m)
break
case "vxxxgay":       
await conn.sendFile(m.chat, enlace3, null, `᥀·࣭࣪̇˖👀◗ *_Contenido_*... ✯✨`, fkontak, m)
break 
case "vxxxbisexual":       
await conn.sendFile(m.chat, enlace4, null, `᥀·࣭࣪̇˖👀◗ *_Contenido_*... ✯✨`, fkontak, m)
break 
case "vxxxrandom":       
await conn.sendFile(m.chat, enlace5, null, `᥀·࣭࣪̇˖👀◗ *_Contenido_*... ✯✨`, fkontak, m)
break 
...
global.pornovidgay = [
"https://telegra.ph/file/d5fc61bceb4cfa16008e7.mp4"]
