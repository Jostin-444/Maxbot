...
text = m.quoted.text
} else return conn.reply(m.chat, `『✦』Ingresa un texto para crear una imagen con dall-e.`, m, fake, )
...
return conn.reply(m.chat, `『✦』 *Ocurrio un error inesperado en el comando.*`, m, fake, )
}
