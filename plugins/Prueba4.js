...
let frep = { contextInfo: { externalAdReply: {title: IDexotic.botInfo, body: IDexotic.botDescrip, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer() }}}
