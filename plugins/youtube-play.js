...
await conn.sendMessage(m.chat, { video: { url: mediaa.result }, fileName: `error.mp4`, thumbnail: mediaa.thumb, mimetype: 'video/mp4' }, { quoted: m })     
} catch {  
try {
...
conn.reply(m.chat, '🚩 *Ocurrió un error al buscar:* ' + text, m, fake)
}}
